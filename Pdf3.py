...
data = {
    ...
    "seller_location": "Ann Arbor, MI 48104",  # Placeholder address
    ...
    "transfer_date_1": "March 5, 2025",  # Jason to Bonnie
    "transfer_date_2": "March 6, 2025",  # Bonnie to George
    ...
    "law_firm_location": "Ohio"  # Placeholder
}
...
def add_header_footer(canvas, doc):
    ...
    canvas.rect(inch + 5 * inch, letter[1] - 2 * inch, 1.5 * inch, 0.25 * inch, fill=1)  # Barcode simulation
    ...
    canvas.drawString(letter[0] - 2 * inch, 0.25 * inch, f"Page {page_num} of {doc.pageCount} | Certified by: {data['clerk_initials']} | Copy Fee: $1.00")
