...
def generate_usbc_letter_with_seal(output_path="USBC_Letter_Jason_Lucas_Final.pdf"):
    # Canvas setup
    ...
    # Load the seal image
    seal_path = "/mnt/data/pdf_images/image_1_1.png"
    seal_width = 1.2 * inch
    seal_height = 1.2 * inch

    # Draw seal in top-right corner
    c.drawImage(seal_path, width - margin - seal_width, y - seal_height + 5, 
...
# Run the function
generate_usbc_letter_with_seal()
