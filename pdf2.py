...
def generate_pdf(data):
    ...
    doc = SimpleDocTemplate(pdf_file, pagesize=letter, rightMargin=72, leftMargin=72, topMargin=108, bottomMargin=72)  # 3-inch top margin
    elements = []
    ...
    create_section(doc, "Documentary Stamp Tax Receipt", [
        ...
        f"Paid on {data['transfer_date']} | Receipt #: {random.randint(1000, 9999)} | Issued by {data['county']} Tax Collector Office."
    ])
