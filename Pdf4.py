...
def add_header_footer(canvas, doc):
    ...
    canvas.drawString(letter[0] - 2 * inch, 0.25 * inch, f"Page {page_num} of {len(elements)} | Certified by: {data['clerk_initials']} | Copy Fee: $1.00")
...
# Function to create a section (corrected to append elements)
